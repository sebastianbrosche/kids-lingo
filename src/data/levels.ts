...
// 18 Dungeon Crawler Carl inspired monsters
// Level 1: Goblin Murder Dozer (the first monster they meet)
// Level 2: Ratling Swarm
// Level 3: Goblin Scullion (pineapple on stick, saucepan on head)

const dccMonsters: Record<number, Monster> = {
  1: {
    name: 'Goblin Murder Dozer',
    emoji: '🚜',
    description: 'A goblin driving a jury-rigged bulldozer made of scrap metal and bad intentions',
    weapon: '🔪',
    helmet: '⛑️',
  },
  2: {
